...
function interactuar() {
    ...
    switch (obj.tipo) {
        case 'pista':
            ...
            break;
        case 'bufe':
            mostrarTexto('Un buf\u00E9 con platos exquisitos. \u00A1Huele genial!', 2500);
            break;
        case 'cuadro':
            mostrarTexto('"El Sal\u00F3n Dorado" - Una obra que captura la esencia de este lugar.', 3000);
            break;
    }
}
...
// ============================================
juego.estado = Estado.INTRO;
requestAnimationFrame(gameLoop);22:53 17/4/2026